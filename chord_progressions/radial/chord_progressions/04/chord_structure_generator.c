 ...
 */
  ...
  strcpy(layer_3[4].symbol, "0"); layer_3[4].highlighted = true;
  strcpy(layer_3[5].symbol, ""); layer_3[5].highlighted = true;
  strcpy(layer_3[6].symbol, ""); layer_3[6].highlighted = true;
  strcpy(layer_3[7].symbol, "3"); layer_3[7].highlighted = true;
  ...
  strcpy(layer_3[11].symbol, "7"); layer_3[11].highlighted = true;
  strcpy(layer_3[0].symbol, ""); layer_3[0].highlighted = true;
  strcpy(layer_3[1].symbol, ""); layer_3[1].highlighted = true;
  strcpy(layer_3[2].symbol, "10"); layer_3[2].highlighted = true;
