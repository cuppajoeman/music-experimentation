 ...
 */
  ...
  strcpy(layer_3[9].symbol, "0"); layer_3[9].highlighted = true;
  strcpy(layer_3[10].symbol, ""); layer_3[10].highlighted = true;
  strcpy(layer_3[11].symbol, ""); layer_3[11].highlighted = true;
  strcpy(layer_3[0].symbol, "3"); layer_3[0].highlighted = true;
  ...
  strcpy(layer_3[4].symbol, "7"); layer_3[4].highlighted = true;
  strcpy(layer_3[5].symbol, ""); layer_3[5].highlighted = true;
  strcpy(layer_3[6].symbol, ""); layer_3[6].highlighted = true;
  strcpy(layer_3[7].symbol, "10"); layer_3[7].highlighted = true;
